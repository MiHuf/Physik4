...
\begin{align*}
  u(x) = u(R - R_0) = \left. u(x) \right|_{x = 0} +
    a \cdot \left.\frac{\mathrm d u(x)}{\mathrm d x} \right|_{x = 0} + \frac{1}{2} \cdot k
    \left. \frac{\mathrm d^2 u(x)}{\mathrm d x^2} \right|_{x = 0}
\end{align*}
Der Koeffizient $a$ verschwindet und $k$ entspricht bei einem Federpendel
gerade der Federkonstanten.
